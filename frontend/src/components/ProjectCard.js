...
export function renderProjects(projects) {
  ...
  const projectCards = projects.map(project => {
    ...
    const githubLink = project.githubUrl 
      ? `<a href="${project.githubUrl}" target="_blank" rel="noopener noreferrer" class="project-github-link" aria-label="GitHub Repository for ${project.title}">
          ...
          <span class="github-text">Source â†—</span>
         </a>`
      : '';
