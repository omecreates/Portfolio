    ...
    <section class="slide hero-section" id="hero">
      ...
      <div class="hero-content reveal active">
        ...
        <div class="hero-actions">
          ...
          <a href="/resume.pdf" target="_blank" class="btn btn-outline">Download Resume</a>
          <a href="#contact" class="btn btn-outline">Contact Me</a>
          <a href="https://github.com/omecreates" target="_blank" rel="noopener noreferrer" class="btn btn-icon" aria-label="GitHub">
          ...
          <a href="${linkedinUrl}" target="_blank" rel="noopener noreferrer" class="btn btn-icon" aria-label="LinkedIn">
