  ...
  return `
    <nav class="navbar" id="navbar">
      <div class="nav-container">
        <a href="#hero" class="nav-logo">PD SHAHEED ALI</a>
        ...
        <div class="nav-menu" id="nav-menu">
          ...
          <div class="nav-socials">
            ...
            <a href="https://www.linkedin.com/in/pdshahidali/" target="_blank" rel="noopener noreferrer" class="nav-social-link" aria-label="LinkedIn">
