  ...
  },
{
  ...
  description: "Developed a search engine in Java that indexes text data and enables efficient keyword-based searching. Implemented string matching, data structures, and ranking logic to retrieve relevant results based on user queries.",
  techBadges: [
    "Java",
    "Data Structures",
    "Algorithms",
...
const FALLBACK_SKILLS = [
  ...
  },
  {
    ...
    items: ["React", "HTML5", "CSS3", "FastAPI", "Flask", "REST APIs"]
  },
  {
    category: "AI & Machine Learning",
    items: ["Machine Learning", "NLP", "Scikit-Learn", "spaCy", "NLTK", "Data Analytics"]
  },
  {
    category: "Embedded Systems & IoT",
    items: ["Arduino", "Embedded C/C++", "IoT", "Sensors", "I2C", "UART"]
  },
  {
    category: "Mobile Development",
    items: ["Android Studio", "Java", "Firebase"]
  },
  {
    category: "Tools & Technologies",
    items: ["Git", "GitHub", "Linux", "VS Code", "Vite", "Postman"]
  }
];
...
function renderFooter(profile) {
  ...
  const name = profile?.name || "PD Shaheed Ali Khan";
  const linkedin = profile?.socials?.linkedin || "https://www.linkedin.com/in/pdshahidali/";
  const github = profile?.socials?.github || "https://github.com/omecreates";
